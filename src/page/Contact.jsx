    ...
    <div id="contact">
      <section className="bg-gray-900 dark:bg-gray-900">
        <div className="container mx-auto px-8 py-8">
          ...
          <div className="flex justify-center items-center md:flex-row flex-col px-10">
            <form action="https://fabform.io/f/xxxxx" method="post" className="max-w-md mx-auto mt-20 p-6 bg-[#0D1117] border rounded-lg shadow-lg w-full">
                <h2 className="text-2xl font-bold mb-6 text-gray-700 ">Feedback Form</h2>
                    <div className="mb-4">
                    ...
                    Feedback:
                        ...
                        <textarea className="shadow appearance-none border rounded w-full py-2 px-3 text-white leading-tight focus:outline-none focus:shadow-outline" id="feedback" rows="5" placeholder="Enter your feedback"></textarea>
                    </div>
