    ...
    <section className='bg-gray-900 py-12' id='project'>
      <div className="container mx-auto px-4 relative">
        ...
        {projects.map((proj, idx) => (
          <div key={idx} className={`relative mb-12 flex flex-col md:flex-row items-center md:items-start ${proj.position === 'left' ? 'md:justify-start' : 'md:justify-end'}`}>
            {proj.position === 'left' && (
            ...
            {/* Timeline Dot and Icon */}
               <div className="z-10 md:absolute md:left-1/2 transform md:-translate-x-1/2 flex items-center mb-6 md:mb-0 relative">
                    {/* Centered icon on the line */}
                    ...
                    {/* Period text with alternating position */}
                    <p
