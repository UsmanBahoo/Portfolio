...
function Project() {
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          >
            ...
            <h3 className="text-xl font-bold mt-2 flex justify-between">Food Delivery  <span>Mern Stack</span></h3>
            <p className="mt-1">A React + Express.js + MongoDB + Node.js-based food delivery system with categories, JWT authentication and Bcrypt password hashing.</p>
          ...
          >
            ...
            <h3 className="text-xl font-bold mt-2 flex justify-between">Chat Application <span>Mern Stack</span></h3>
            <p className="mt-1">A real-time chat web application built with React and Socket.io featuring instant messaging, user authentication, and responsive design.</p>
          ...
          >
            ...
            <h3 className="text-xl font-bold mt-2 flex justify-between">KeunePakistan <span>Shopify Store</span></h3>
            <p className="mt-1">A premium Shopify store for Keune professional hair care products featuring product catalogs and brand showcase.</p>
          ...
          >
            ...
            <h3 className="text-xl font-bold mt-2 flex justify-between">Salon Designer  <span>Shopify Store</span></h3>
            <p className="mt-1">A sophisticated Shopify e-commerce store for salon and beauty products with custom design and optimized experience.</p>
            <p className="mt-1 text-sm text-purple-500">Shopify • Liquid • HTML • CSS • JavaScript</p>
          ...
          >
            ...
            <h3 className="text-xl font-bold mt-2 flex justify-between">Focuspc <span>WordPress Website</span></h3>
            <p className="mt-1">A custom WordPress website for gaming PC business with responsive design and optimized performance.</p>
          ...
          >
            ...
            <h3 className="text-xl font-bold mt-2 flex justify-between">Eexor <span>WordPress Website</span></h3>
            <p className="mt-1">A modern WordPress business website for Eexor, featuring service pages and SEO optimization with contact forms.</p>
            <p className="mt-1 text-sm text-purple-500">WordPress • HTML • CSS • JavaScript • Responsive Design</p>
